...
### Patient Seeds ###
3.times {
    Patient.create(name: Faker::Name.name, dob: Faker::Date.birthday(min_age: 21, max_age: 90), gender: Faker::Gender.binary_type, telephone: Faker::PhoneNumber.phone_number, address: Faker::Address.full_address, hosp_number: Faker::Number.number(digits: 10), nhs_number: Faker::NationalHealthService.british_number) 
}
